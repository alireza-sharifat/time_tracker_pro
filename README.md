...
Download the latest TimeTracker.exe from the Releases section, double‑click, and you're ready to go.
...
| The chart window is blank | Check that you have matplotlib installed and that there is data to display. |
| Tracking doesn't start | Ensure you are running Windows and have granted any necessary permissions. |
| Data not saving | Verify that the application has write permissions in its directory. |
